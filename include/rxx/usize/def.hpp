#ifndef __RXX_USIZE_DEF_HPP__
#define __RXX_USIZE_DEF_HPP__
...
public:
    ...
    constexpr usize(u8 i) noexcept;
    constexpr usize(u64 i) noexcept;
    ...
    auto operator+=(usize rhs) noexcept -> usize& {
        m_value += rhs.m_value;
        return *this;
    }
...
#endif /* end of include guard: __RXX_USIZE_DEF_HPP__ */
